...
Each time input data are updated, [github action](https://github.com/xvnpw/ai-devsecops-action) runs, query is sent to ChatGPT-3.5 and results are committed back to repository as output.
...
| --- | --- | --- | --- | --- |
| Project description | [PROJECT.md](./PROJECT.md) | High level description of the project with business explanation and listed core features | High level security design review | [PROJECT_SECURITY.md](./PROJECT_SECURITY.md) and as [pull request](https://github.com/xvnpw/ai-nutrition-pro-design-gpt3.5/pull/1) |
